...
export function exportToMarkdown(projectName: string, blocks: ExportBlock[]): string {
  if (blocks.length === 0) {
    return [
      ...
      ``,
      `---`,
      `*Generated by [Synapse]([YOUR_DEPLOYED_URL])*`,
    ].join("\n")
  }
  ...
  lines.push(`source: Synapse — [YOUR_DEPLOYED_URL]`)
  lines.push(`---`)
  lines.push(``)
  ...
  lines.push(``)
  lines.push(`> **Generated by [Synapse]([YOUR_DEPLOYED_URL])** · ${date} · ${blocks.length} node${blocks.length !== 1 ? "s" : ""}`)
  lines.push(``)
  ...
  lines.push(`---`)
  lines.push(``)
  lines.push(`*Generated by [Synapse]([YOUR_DEPLOYED_URL]) · ${date}*`)
  lines.push(``)
