...
export function exportToMarkdown(projectName: string, blocks: ExportBlock[]): string {
  if (blocks.length === 0) {
    return [
      ...
      ``,
      `---`,
      `*Generated by [Synapse](https://synapse-sarthak-47.vercel.app)*`,
    ].join("\n")
  }
  ...
  lines.push(`source: Synapse — https://synapse-sarthak-47.vercel.app`)
  lines.push(`---`)
  lines.push(``)
  ...
  lines.push(``)
  lines.push(`> **Generated by [Synapse](https://synapse-sarthak-47.vercel.app)** · ${date} · ${blocks.length} node${blocks.length !== 1 ? "s" : ""}`)
  lines.push(``)
  ...
  lines.push(`---`)
  lines.push(``)
  lines.push(`*Generated by [Synapse](https://synapse-sarthak-47.vercel.app) · ${date}*`)
  lines.push(``)
